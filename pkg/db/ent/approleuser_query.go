...
func (aruq *AppRoleUserQuery) IDs(ctx context.Context) ([]uint32, error) {
	var ids []uint32
...
func (aruq *AppRoleUserQuery) GroupBy(field string, fields ...string) *AppRoleUserGroupBy {
	grbuild := &AppRoleUserGroupBy{config: aruq.config}
...
func (aruq *AppRoleUserQuery) Select(fields ...string) *AppRoleUserSelect {
	...
	selbuild := &AppRoleUserSelect{AppRoleUserQuery: aruq}
	selbuild.label = approleuser.Label
	selbuild.flds, selbuild.scan = &aruq.fields, selbuild.Scan
	return selbuild
}
