...
func (auq *AppUserQuery) FirstID(ctx context.Context) (id uint32, err error) {
	var ids []uint32
...
func (auq *AppUserQuery) FirstIDX(ctx context.Context) uint32 {
...
func (auq *AppUserQuery) OnlyID(ctx context.Context) (id uint32, err error) {
	var ids []uint32
...
func (auq *AppUserQuery) OnlyIDX(ctx context.Context) uint32 {
...
func (auq *AppUserQuery) IDs(ctx context.Context) ([]uint32, error) {
	var ids []uint32
...
func (auq *AppUserQuery) IDsX(ctx context.Context) []uint32 {
	ids, err := auq.IDs(ctx)
	if err != nil {
		panic(err)
	}
