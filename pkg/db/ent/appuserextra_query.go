...
func (aueq *AppUserExtraQuery) IDs(ctx context.Context) ([]uint32, error) {
	var ids []uint32
...
func (aueq *AppUserExtraQuery) GroupBy(field string, fields ...string) *AppUserExtraGroupBy {
	grbuild := &AppUserExtraGroupBy{config: aueq.config}
...
func (aueq *AppUserExtraQuery) Select(fields ...string) *AppUserExtraSelect {
	...
	selbuild := &AppUserExtraSelect{AppUserExtraQuery: aueq}
	selbuild.label = appuserextra.Label
	selbuild.flds, selbuild.scan = &aueq.fields, selbuild.Scan
	return selbuild
}
