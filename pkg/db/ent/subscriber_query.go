...
func (sq *SubscriberQuery) Order(o ...OrderFunc) *SubscriberQuery {
...
func (sq *SubscriberQuery) FirstID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (sq *SubscriberQuery) FirstIDX(ctx context.Context) uuid.UUID {
...
func (sq *SubscriberQuery) OnlyID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (sq *SubscriberQuery) OnlyIDX(ctx context.Context) uuid.UUID {
...
func (sq *SubscriberQuery) IDs(ctx context.Context) ([]uuid.UUID, error) {
	var ids []uuid.UUID
...
func (sq *SubscriberQuery) IDsX(ctx context.Context) []uuid.UUID {
	ids, err := sq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (sq *SubscriberQuery) GroupBy(field string, fields ...string) *SubscriberGroupBy {
	grbuild := &SubscriberGroupBy{config: sq.config}
...
func (sq *SubscriberQuery) Select(fields ...string) *SubscriberSelect {
	...
	selbuild := &SubscriberSelect{SubscriberQuery: sq}
	selbuild.label = subscriber.Label
...
func (sq *SubscriberQuery) prepareQuery(ctx context.Context) error {
	...
	if subscriber.Policy == nil {
		return errors.New("ent: uninitialized subscriber.Policy (forgotten import ent/runtime?)")
	}
...
func (sq *SubscriberQuery) sqlExist(ctx context.Context) (bool, error) {
...
func (sq *SubscriberQuery) ForUpdate(opts ...sql.LockOption) *SubscriberQuery {
...
func (sq *SubscriberQuery) ForShare(opts ...sql.LockOption) *SubscriberQuery {
	if sq.driver.Dialect() == dialect.Postgres {
		sq.Unique(false)
	}
	sq.modifiers = append(sq.modifiers, func(s *sql.Selector) {
...
func (sgb *SubscriberGroupBy) Scan(ctx context.Context, v interface{}) error {
...
func (sgb *SubscriberGroupBy) sqlScan(ctx context.Context, v interface{}) error {
...
func (sgb *SubscriberGroupBy) sqlQuery() *sql.Selector {
...
func (ss *SubscriberSelect) Scan(ctx context.Context, v interface{}) error {
	if err := ss.prepareQuery(ctx); err != nil {
		return err
	}
	ss.sql = ss.SubscriberQuery.sqlQuery(ctx)
	return ss.sqlScan(ctx, v)
}

func (ss *SubscriberSelect) sqlScan(ctx context.Context, v interface{}) error {
	rows := &sql.Rows{}
