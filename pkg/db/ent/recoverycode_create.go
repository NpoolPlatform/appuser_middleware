...
func (rcc *RecoveryCodeCreate) defaults() error {
	if _, ok := rcc.mutation.CreatedAt(); !ok {
		if recoverycode.DefaultCreatedAt == nil {
			return fmt.Errorf("ent: uninitialized recoverycode.DefaultCreatedAt (forgotten import ent/runtime?)")
		}
		v := recoverycode.DefaultCreatedAt()
		rcc.mutation.SetCreatedAt(v)
	}
	if _, ok := rcc.mutation.UpdatedAt(); !ok {
		if recoverycode.DefaultUpdatedAt == nil {
			return fmt.Errorf("ent: uninitialized recoverycode.DefaultUpdatedAt (forgotten import ent/runtime?)")
		}
		v := recoverycode.DefaultUpdatedAt()
		rcc.mutation.SetUpdatedAt(v)
	}
	if _, ok := rcc.mutation.DeletedAt(); !ok {
		if recoverycode.DefaultDeletedAt == nil {
			return fmt.Errorf("ent: uninitialized recoverycode.DefaultDeletedAt (forgotten import ent/runtime?)")
		}
		v := recoverycode.DefaultDeletedAt()
		rcc.mutation.SetDeletedAt(v)
	}
	if _, ok := rcc.mutation.EntID(); !ok {
		if recoverycode.DefaultEntID == nil {
			return fmt.Errorf("ent: uninitialized recoverycode.DefaultEntID (forgotten import ent/runtime?)")
		}
		v := recoverycode.DefaultEntID()
		rcc.mutation.SetEntID(v)
	}
	if _, ok := rcc.mutation.AppID(); !ok {
		if recoverycode.DefaultAppID == nil {
			return fmt.Errorf("ent: uninitialized recoverycode.DefaultAppID (forgotten import ent/runtime?)")
		}
		v := recoverycode.DefaultAppID()
		rcc.mutation.SetAppID(v)
	}
	if _, ok := rcc.mutation.UserID(); !ok {
		if recoverycode.DefaultUserID == nil {
			return fmt.Errorf("ent: uninitialized recoverycode.DefaultUserID (forgotten import ent/runtime?)")
		}
...
func (rcc *RecoveryCodeCreate) check() error {
	if _, ok := rcc.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`ent: missing required field "RecoveryCode.created_at"`)}
	}
	if _, ok := rcc.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New(`ent: missing required field "RecoveryCode.updated_at"`)}
	}
	if _, ok := rcc.mutation.DeletedAt(); !ok {
		return &ValidationError{Name: "deleted_at", err: errors.New(`ent: missing required field "RecoveryCode.deleted_at"`)}
	}
	if _, ok := rcc.mutation.EntID(); !ok {
		return &ValidationError{Name: "ent_id", err: errors.New(`ent: missing required field "RecoveryCode.ent_id"`)}
	}
	return nil
}
